...
train_x_f_dataframe.to_csv("/Users/sosoon/coding/myo_train_data/train_x2.csv",header=False, index=False)
train_y_dataframe.to_csv("/Users/sosoon/coding/myo_train_data/train_y2.csv",header=False, index=False)